...
![](figures\system_architecture_diagram.jpg)
...
- 用户协议以及安装位置选择，默认安装在`D`盘
  ...
  ![](figures\select_installation_path.png)

- 创建快捷方式，并运行星鉴

  ![](figures\create_shortcut.png)

  ![](figures\run_star_detection.png)

安装成功运行结果如下所示

![](figures\successful_execution.png)
